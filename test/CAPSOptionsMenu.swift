...
open class CAPSOptionsMenu: UIView, UIGestureRecognizerDelegate {
    ...
    public init(viewController: UIViewController, barButtonItem: UIBarButtonItem, keepBarButtonAtEdge: Bool) {
        ...
        barItem?.target = self
        barItem?.action = #selector(CAPSOptionsMenu.barButtonAction(_:event:))
    ...
    open func customizeWith(maxMenuWidth: CGFloat?, shadow: Bool?, shadowColor: UIColor?, backgroundColor: UIColor?, borderWidth: CGFloat?, borderColor: UIColor?, actionButtonsTitleColor: UIColor?, actionButtonsHighlightedColor: UIColor?, cornerRadius: CGFloat?, animationOption: AnimationOption?, animationDuration: TimeInterval?) {
    ...
    /// - parameters:
    ///   - width: Maximum width of the menu
    open func menuMaxWidth(_ width: CGFloat) {
        maxMenuWidth = width
    }
    ...
    /// - parameters:
    ///   - shadow: If `true`, shadow is added to the menu
    open func menuHasShadow(_ shadow: Bool) {
        hasShadow = shadow
    ...
    open func menuShadowColor(_ color: UIColor) {
    ...
    open func menuBackgroundColor(_ color: UIColor) {
    ...
    open func menuBorderWidth(_ width: CGFloat) {
    ...
    open func menuBorderColor(_ color: UIColor) {
    ...
    open func menuActionButtonsTitleColor(_ color: UIColor) {
    ...
    open func menuActionButtonsHighlightedColor(_ color: UIColor) {
    ...
    open func menuCornerRadius(_ radius: CGFloat) {
    ...
    open func menuAnimationOption(_ option: AnimationOption) {
    ...
    open func menuAnimationDuration(_ duration: TimeInterval) {
    ...
    // MARK: - Menu Functions
    open func barButtonAction(_ sender:UIBarButtonItem, event: UIEvent) {
    ...
    // MARK: - Action
    open func addAction(_ action: CAPSOptionsMenuAction) {
    ...
    fileprivate func addButtonForAction(_ action: CAPSOptionsMenuAction) {
        ...
        actionButton.setImage(action.image, for: UIControlState())
